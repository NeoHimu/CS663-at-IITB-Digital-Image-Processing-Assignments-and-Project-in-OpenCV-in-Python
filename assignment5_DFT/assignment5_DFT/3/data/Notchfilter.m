...
I = load('image_low_frequency_noise.mat');
footBall=I.Z;
...
H1 = notch('ideal', size(footBall,1), size(footBall,2), 3, 119+129+4,124+129-6);
H2 = notch('ideal', size(footBall,1), size(footBall,2), 3, 139-129-4, 134-129+6);
...
F=fft2(double(footBall),size(footBall,1), size(footBall,2));
